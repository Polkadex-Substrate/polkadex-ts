    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          cancelButton:
            "group-[.toast]:bg-secondary-base group-[.toast]:text-primary group-[.toast]:hover:text-current group-[.toast]:hover:bg-secondary-hover group-[.toast]:active:bg-secondary-pressed group-[.toast]:transition-colors group-[.toast]:duration-300 group-[.toast]:text-medium group-[.toast]:text-xs",
